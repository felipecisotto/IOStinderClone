...
//  TinderClone
//
//  Created by Felipe Cisotto on 13/04/20.
...
class MatchVC: UIViewController,UITextFieldDelegate{
    ...
    let voltarButton: UIButton = {
        ...
        let button = UIButton()
        button.setTitle("Voltar ao Tinder", for: .normal)
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(keyboradHide), name: UIResponder.keyboardWillHideNotification, object: nil)
    ...
    @objc func keyboradHide(notification:NSNotification){
